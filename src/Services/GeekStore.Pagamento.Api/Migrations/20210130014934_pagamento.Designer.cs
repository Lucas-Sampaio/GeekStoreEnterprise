...
namespace GeekStore.Pagamentos.Api.Migrations
{
    ...
    [Migration("20210130014934_pagamento")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeekStore.Pagamentos.Api.Models.Pagamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GeekStore.Pagamentos.Api.Models.Transacao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GeekStore.Pagamentos.Api.Models.Transacao", b =>
                {
                    b.HasOne("GeekStore.Pagamentos.Api.Models.Pagamento", "Pagamento")
                        .WithMany("Transacoes")
